...
const Aboutme = () => {
  ...
  return (
    <section id="about" className="py-16 md:py-28 bg-neutral-50 border-t border-neutral-100 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          ...
          >
            {services.map((svc) => (
              <SwiperSlide key={svc.title} className="!h-auto">
                <div className="group p-6 rounded-2xl border border-neutral-200 bg-white hover:border-neutral-300 hover:shadow-sm transition-all duration-300 h-full">
        ...
        <div className="hidden md:grid grid-cols-2 gap-6">
          {services.map((svc) => (
            <div
              key={svc.title}
              className="group p-6 rounded-2xl border border-neutral-200 bg-white hover:border-neutral-300 hover:shadow-sm transition-all duration-300 h-full"
            >
              <div className="w-11 h-11 rounded-xl bg-neutral-100 flex items-center justify-center text-neutral-500 group-hover:bg-neutral-900 group-hover:text-white transition-colors duration-300 mb-5">
                {svc.icon}
              </div>
